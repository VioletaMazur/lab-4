...
int main() {
    ...
    case 6: {
        int number;
        int maxNumber = 0; // початкове значення максимального числа
        cout << "Введіть послідовність цілих чисел. Нуль – ознака кінця:" << endl;
        do {
            cin >> number;
    ...
    case 7: {
        ...
        if (n < 2) {
            ...
            if (n == 1) cout << "Число Фібоначчі з номером " << 1 << ": " << b << endl;
        }
        else {
            if (n % 2 == 1) t = (n + 1) / 2;
            else t = n / 2;
            ...
            if (n % 2 == 0) cout << "Число Фібоначчі з номером " << n << ": " << b << endl;
            else cout << "Число Фібоначчі з номером " << n << ": " << a << endl;
        }
        break;
    }
